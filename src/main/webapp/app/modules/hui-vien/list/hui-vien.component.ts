...
export class HuiVienComponent implements OnInit {
  ...
  trackId = (_index: number, item: IHuiVien): number => this.huiVienService.getHuiVienIdentifier(item);

  ngOnInit(): void {
    this.load();
  }

  delete(huiVien: IHuiVien): void {
    const modalRef = this.modalService.open(HuiVienDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.huiVien = huiVien;
